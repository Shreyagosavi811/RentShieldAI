  ...
  return (
    ...
    >
      ...
      <section className="hero-section relative overflow-hidden pt-16 pb-24 px-6">
        ...
        {/* Floating accents */}
        <div
          className="absolute top-16 left-12 float-anim"
          style={{ animationDelay: "0s" }}
        >
          <svg width="48" height="20" viewBox="0 0 48 20">
            <path
              d="M0 10 Q12 0 24 10 Q36 20 48 10"
              stroke="#f97316"
              strokeWidth="3"
              fill="none"
              strokeLinecap="round"
        ...
        <div
          className="absolute top-20 right-24 float-anim"
          style={{ animationDelay: "1s" }}
        >
          <svg width="24" height="24" viewBox="0 0 24 24">
            <path
              d="M12 2 L14.5 9.5 L22 9.5 L16 14.5 L18.5 22 L12 17.5 L5.5 22 L8 14.5 L2 9.5 L9.5 9.5 Z"
              fill="rgba(37,99,235,0.4)"
            />
          </svg>
        </div>
        <div
          className="absolute bottom-20 right-16 float-anim"
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="fade-up inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-xs text-white/80 font-medium">
              AI-Powered Rental Verification
            </span>
          </div>
          ...
          <p className="fade-up-3 text-white/70 text-sm max-w-xl mx-auto mb-8 leading-relaxed">
            ...
            <strong className="text-white">safety and fairness</strong> of
            rental properties and PGs.
          </p>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-xs text-gray-400 leading-relaxed">
              Helping students and renters find safe, fair, and trustworthy
              rental properties.
            </p>
          </div>
          ...
          {[
            {
              title: "Site",
              links: ["Home", "PGss", "About Us", "Contact Us"],
            },
