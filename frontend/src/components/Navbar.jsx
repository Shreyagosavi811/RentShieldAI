...
const Navbar = () => {
  ...
  return (
    <nav style={{ fontFamily: "'DM Sans', sans-serif" }} className="w-full bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="flex items-center gap-2">
          <div className="w-9 h-9 rounded-lg flex items-center justify-center" style={{ background: "linear-gradient(135deg, #1a3a6b, #2563eb)" }}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
              ...
              <path d="M12 10v-3" stroke="white" strokeWidth="1.5" strokeLinecap="round"/>
            </svg>
          </div>
          <span className="text-xl font-bold" style={{ color: "#1a3a6b", letterSpacing: "-0.5px" }}>
