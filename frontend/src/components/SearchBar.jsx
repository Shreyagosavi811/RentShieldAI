...
const SearchBar = () => {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100" style={{ boxShadow: "0 8px 40px rgba(37,99,235,0.15)" }}>
        {/* City Input */}
        ...
        <button
          ...
          style={{ background: "linear-gradient(135deg, #1a3a6b, #2563eb)", fontFamily: "'DM Sans', sans-serif" }}
        >
          Search PGs
        </button>
      </div>
